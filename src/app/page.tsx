              ...
              <table className="w-full text-xs min-w-[480px]">
                <thead>
                  <tr className="bg-[#041224] border-b-2 border-b-[#E62800]">
                    <th className="text-left px-2 py-1.5 text-xs font-semibold uppercase tracking-wider text-white">Línea</th>
                    <th className="text-center px-2 py-1.5 text-xs font-semibold uppercase tracking-wider text-white">Prima Neta</th>
                    <th className="text-center px-2 py-1.5 text-xs font-semibold uppercase tracking-wider text-white">Año Ant.</th>
                    <th className="text-center px-2 py-1.5 text-xs font-semibold uppercase tracking-wider text-white">Presupuesto</th>
                ...
                <tbody className="divide-y divide-gray-100">
                  ...
                  <tr className="font-bold border-t-2 border-gray-300 bg-[#041224]">
                    <td className="px-2 py-1.5 text-xs font-bold text-white">Total</td>
                    <td className="px-2 py-1.5 text-center text-xs font-bold tabular-nums text-white">{fmt(total)}</td>
                    <td className="px-2 py-1.5 text-center text-xs font-bold tabular-nums text-white">{fmt(totalAA)}</td>
                    <td className="px-2 py-1.5 text-center text-xs font-bold tabular-nums text-gray-400">{fmt(totalPpto)}</td>
                    <td className="px-2 py-1.5 text-center text-xs font-bold tabular-nums" style={{ color: (total - totalPpto) < 0 ? '#E62800' : '#059669' }}>
